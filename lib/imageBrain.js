...
Output ONLY minified JSON with keys: layout, hazard, regionStates, watchStates, cities, alertLabel, dateRange, regionLabel, keyword, callouts, bottomTitle, bottomBody, badge.`;
...
Write the JSON spec.`;
  const j = await genJSON(SYS(cities), user, { maxTokens: 900 });
