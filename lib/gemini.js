...
async function geminiImage(promptText, timeoutMs, refs = []) {
...
export async function generateFullImage(prompt, { timeoutMs = 60000, refs = [] } = {}) {
  return geminiImage(String(prompt || ""), timeoutMs, refs);
}
